...
const Timing = () => {
  ...
  const [viewportAmount, setViewportAmount] = useState(
    window.innerWidth <= 650 ? 0.3 : 0.7
  );

  useEffect(() => {
    const handleResize = () => {
      setViewportAmount(window.innerWidth <= 500 ? 0.2 : 0.7);
    };
  ...
  return (
    <>
      <div id="service">
        <div
          style={{
            backgroundPositionY: -motionValue,
            backgroundImage: 'url("assets/timing.jpg")',
          }}
          ref={containerRef}
          className="bg-cover bg-center text-white py-28 max-1200:py-20 relative"
        >
          <motion.div
